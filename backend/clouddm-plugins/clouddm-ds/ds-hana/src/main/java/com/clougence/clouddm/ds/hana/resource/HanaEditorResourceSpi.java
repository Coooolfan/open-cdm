 ...
 */
package com.clougence.clouddm.ds.hana.resource;
...
public class HanaEditorResourceSpi implements ResourceSpi {

    private final ResourceLoader loader;

    public HanaEditorResourceSpi(ClassLoader loader){
        this.loader = new ClassPathResourceLoader(Objects.requireNonNull(loader, "loader"), "");
    }

    @Override
    public String name() {
        return DataSourceType.Hana.name();
    }
