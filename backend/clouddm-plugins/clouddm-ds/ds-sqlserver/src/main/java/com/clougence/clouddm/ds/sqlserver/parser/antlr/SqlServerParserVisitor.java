...
public interface SqlServerParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link SqlServerParser#create_login_sql_server_with}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCreate_login_sql_server_with(SqlServerParser.Create_login_sql_server_withContext ctx);
	/**
