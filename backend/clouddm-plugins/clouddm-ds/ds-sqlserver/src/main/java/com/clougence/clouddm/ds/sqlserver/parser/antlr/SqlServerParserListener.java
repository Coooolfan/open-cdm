...
public interface SqlServerParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SqlServerParser#create_login_sql_server_with}.
	 * @param ctx the parse tree
	 */
	void enterCreate_login_sql_server_with(SqlServerParser.Create_login_sql_server_withContext ctx);
	/**
	 * Exit a parse tree produced by {@link SqlServerParser#create_login_sql_server_with}.
	 * @param ctx the parse tree
	 */
	void exitCreate_login_sql_server_with(SqlServerParser.Create_login_sql_server_withContext ctx);
	/**
