 ...
 */
package com.clougence.clouddm.ds.redis.resource;
...
public class RedisEditorResourceSpi implements ResourceSpi {

    private final ResourceLoader resourceLoader;

    public RedisEditorResourceSpi(ClassLoader loader){
        this.resourceLoader = new ClassPathResourceLoader(Objects.requireNonNull(loader, "loader"), "");
    }

    @Override
    public String name() {
        return DataSourceType.Redis.name();
    }
    ...
    private ResourceObject keywordsResource() {
        return new ClasspathResourceObject(resourceLoader, "META-INF/clougence/db-keywords/redis.keywords", "text/plain;charset=UTF-8", true, true);
    }
}
