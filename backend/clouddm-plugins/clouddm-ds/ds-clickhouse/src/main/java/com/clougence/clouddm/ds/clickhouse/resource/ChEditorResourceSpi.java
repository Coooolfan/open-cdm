 ...
 */
package com.clougence.clouddm.ds.clickhouse.resource;
...
public class ChEditorResourceSpi implements ResourceSpi {

    private final ResourceLoader resourceLoader;

    public ChEditorResourceSpi(ClassLoader loader){
        this.resourceLoader = new ClassPathResourceLoader(Objects.requireNonNull(loader, "loader"), "");
    }

    @Override
    public String name() {
        return DataSourceType.ClickHouse.name();
    }
    ...
    private ResourceObject keywordsResource() {
        return new ClasspathResourceObject(resourceLoader, "META-INF/clougence/db-keywords/clickhouse.keywords", "text/plain;charset=UTF-8", true, true);
    }
}
