 ...
 */
package com.clougence.clouddm.dsfamily.db2.resource;
...
public class Db2EditorResourceSpi implements ResourceSpi {

    private final DataSourceType dataSourceType;
    private final ResourceLoader resourceLoader;

    public Db2EditorResourceSpi(DataSourceType dataSourceType, ClassLoader loader){
    ...
    private ResourceObject keywordsResource() {
        return new ClasspathResourceObject(resourceLoader, "META-INF/clougence/db-keywords/db2.keywords", "text/plain;charset=UTF-8", true, true);
    }
}
