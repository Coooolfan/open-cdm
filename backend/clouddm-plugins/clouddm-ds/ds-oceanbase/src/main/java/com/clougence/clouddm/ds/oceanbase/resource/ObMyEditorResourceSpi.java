...
public class ObMyEditorResourceSpi implements ResourceSpi {

    private final ResourceLoader resourceLoader;

    public ObMyEditorResourceSpi(ClassLoader loader){
        this.resourceLoader = new ClassPathResourceLoader(Objects.requireNonNull(loader, "loader"), "");
    }

    @Override
    public String name() {
        return DataSourceType.OceanBase.name();
    }
    ...
    private ResourceObject keywordsResource() {
        return new ClasspathResourceObject(resourceLoader, "META-INF/clougence/db-keywords/obformysql.keywords", "text/plain;charset=UTF-8", true, true);
    }
}
