 ...
 */
package com.clougence.clouddm.team.provider.oidc.resource;
...
public class OidcLoginIconResourceSpi implements ResourceSpi {

    private final ResourceLoader resourceLoader;

    public OidcLoginIconResourceSpi(ClassLoader loader){
