 ...
 */
package com.clougence.clouddm.team.provider.github.resource;
...
public class GithubScmIconResourceSpi implements ResourceSpi {

    private final ResourceLoader resourceLoader;

    public GithubScmIconResourceSpi(ClassLoader loader) {
    ...
    public ResourceObject findResource(String category, String resourcePath, ResourceRequest request) {
        ...
        return new ClasspathResourceObject(this.resourceLoader, "META-INF/clougence/webside/scm-icon.svg", "image/svg+xml", true, false);
    }
}
