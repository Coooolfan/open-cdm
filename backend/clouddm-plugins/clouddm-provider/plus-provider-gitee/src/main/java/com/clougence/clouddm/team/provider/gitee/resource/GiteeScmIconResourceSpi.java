 ...
 */
package com.clougence.clouddm.team.provider.gitee.resource;
...
public class GiteeScmIconResourceSpi implements ResourceSpi {

    private final ResourceLoader resourceLoader;

    public GiteeScmIconResourceSpi(ClassLoader loader) {
