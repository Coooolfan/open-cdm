package com.clougence.clouddm.console.web.global.mcp.utils;

import static com.clougence.clouddm.console.web.global.mcp.utils.RagUtils.generateUUIDFrom;
...
import com.clougence.clouddm.console.web.global.mcp.json.*;
...
public class JsonSchemaElementUtils {
    ...
    public static Map<String, Object> toMap(JsonSchemaElement jsonSchemaElement, boolean strict, boolean required) {
        if (jsonSchemaElement instanceof JsonObjectSchema jsonObjectSchema) {
            ...
            map.put("type", "null");
            return map;
        } else if (jsonSchemaElement instanceof JsonRawSchema jsonRawSchema) {
