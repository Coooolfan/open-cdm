...
public record InitializeResult(@JsonProperty("protocolVersion") String protocolVersion, @JsonProperty("capabilities") Capabilities capabilities,
    ...
    public record ServerInfo(@JsonProperty("name") String name, @JsonProperty("version") String version) {
    ...
    public record Capabilities(@JsonProperty("tools") Tools tools) {
