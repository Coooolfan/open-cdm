package com.clougence.clouddm.ds.rules.rdb.using_dr.query;
...
public class DrRuleQueryAllowJoinTest extends DrAbstractRuleTest {

    private final String              scriptResource = "rule-test/rdb/query/query-allow-join.txt";
