...
public class McRuleColumnCharLengthTest extends McAbstractRuleTest {
    ...
    public void columnChar_1() throws IOException {
        ...
        sql = "alter table test add columns ( a123 char(10));";
        assert runScript(scriptResource, sql, p1);
    ...
    public void columnNChar_1() throws IOException {
        ...
        assert !runScript(scriptResource, sql, p1);
        sql = "alter table test add columns ( a123 nchar(10));";
        assert runScript(scriptResource, sql, p1);
