...
public class MyRuleTableNameCaseTypeTest extends MyAbstractRuleTest {
    ...
    public void createTableNameCaseType_1() throws IOException {
        ...
        // Upper case
        sql = "create table test.abc_test(id int(4) primary key auto_increment, name varchar(25) not null)";
        assert !runScript(scriptResource, sql, p1);
        sql = "create table test.ABC_TEST(id int(4) primary key auto_increment, name varchar(25) not null)";
        assert runScript(scriptResource, sql, p1);
        sql = "create table test.abcTest(id int(4) primary key auto_increment, name varchar(25) not null)";
        assert !runScript(scriptResource, sql, p1);
        sql = "create table test.AbcTest(id int(4) primary key auto_increment, name varchar(25) not null)";
        assert !runScript(scriptResource, sql, p1);
    }
