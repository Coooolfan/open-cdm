...
public class MyRuleColumnNeedCommentTest extends MyAbstractRuleTest {
    ...
    public void columnNeedComment_1() throws IOException {
        ...
        sql = "alter table test.abc add name varchar(25) comment 'aac';";
        assert runScript(scriptResource, sql, p1);
        sql = "alter table test.abc modify name varchar(25);";
        assert runScript(scriptResource, sql, p1);
        sql = "alter table test.abc modify name varchar(25) comment 'ccc';";
        assert runScript(scriptResource, sql, p1);
    }
    ...
    public void columnNeedComment_2() throws IOException {
        ...
        assert !runScript(scriptResource, sql, p1);
        sql = "alter table test.abc add name varchar(25) comment '';";
        assert !runScript(scriptResource, sql, p1);
        sql = "alter table test.abc add name varchar(25) comment '   ';";
        assert !runScript(scriptResource, sql, p1);
    }
