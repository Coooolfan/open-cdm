package com.clougence.clouddm.ds.rules.rdb.using_ms.insert;
...
public class MsRuleInsertRequireColumnsTest extends MsAbstractRuleTest {
    ...
    public void requireColumns_1() throws IOException {
        ...
        assert !runScript(scriptResource, sql, p1);
        sql = "insert into table1 default values";
        assert !runScript(scriptResource, sql, p1);
    }
