package com.clougence.clouddm.ds.rules.rdb.using_sr.column;
...
public class SrRuleColumnCharLengthTest extends SrAbstractRuleTest {
    ...
    public void columnChar_1() throws IOException {
        ...
        sql = "alter table test add column a123 char(10);";
        assert runScript(scriptResource, sql, p1);
        sql = "alter table test modify column a1 char(10);";
        assert runScript(scriptResource, sql, p1);
    }
    ...
    public void columnChar_2() throws IOException {
        ...
        sql = "alter table test add column a123 char(10);";
        assert runScript(scriptResource, sql, p2);
        sql = "alter table test modify column a123 char(10);";
        assert runScript(scriptResource, sql, p2);
    }
    ...
    //        assert !runScript(scriptResource, sql, p1);
    //        sql = "alter table test add column a123 nchar(10);";
    //        assert runScript(scriptResource, sql, p1);
    //        sql = "alter table test modify column a123 nchar(10);";
    //        assert runScript(scriptResource, sql, p1);
    //    }
    //
    //    @Test
