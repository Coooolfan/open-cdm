...
public class MsRuleColumnCharLengthTest extends MsAbstractRuleTest {
    ...
    public void columnChar_1() throws IOException {
        ...
        assert runScript(scriptResource, sql, p1);
        sql = "alter table test alter column a1 char(10);";
        assert runScript(scriptResource, sql, p1);
    }
    ...
    public void columnNChar_1() throws IOException {
        ...
        assert runScript(scriptResource, sql, p1);
        sql = "alter table test alter column a1 nchar(10);";
        assert runScript(scriptResource, sql, p1);
    }
