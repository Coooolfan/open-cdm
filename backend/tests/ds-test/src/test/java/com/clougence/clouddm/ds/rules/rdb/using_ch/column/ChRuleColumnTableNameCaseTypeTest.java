...
public class ChRuleColumnTableNameCaseTypeTest extends ChAbstractRuleTest {
    ...
    public void columnTableNameCaseType_1() throws IOException {
        ...
        // Upper case
        sql = "alter table test_table modify column abc_test int;";
        assert runScript(scriptResource, sql, p1);
        sql = "create table test_table(abc_test int) engine = test;";
        assert !runScript(scriptResource, sql, p1);
        sql = "alter table test_table add column abc_test int;";
        assert !runScript(scriptResource, sql, p1);
        ...
        sql = "alter table test_table rename column c  to ABC_TEST;";
        assert runScript(scriptResource, sql, p1);
        sql = "create table test_table(abcTest int) engine = test;";
        assert !runScript(scriptResource, sql, p1);
        sql = "alter table test_table add column abcTest int;";
        assert !runScript(scriptResource, sql, p1);
