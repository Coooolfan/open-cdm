...
public class ChRuleQueryAllowUnionTest extends ChAbstractRuleTest {
    ...
    public void selectAndWithTest_1() throws IOException {
        ...
        // has and allow = false
        sql = "select * from table_1 union all select * from table_2";
        assert !runScript(scriptResource, sql, p1);
        sql = "select * from (select * from table_1 union all select * from table_2) t";
        assert !runScript(scriptResource, sql, p1);
        sql = "select id from table_3 where id in (select id from table_1 union all select id from table_2)";
        assert !runScript(scriptResource, sql, p1);
