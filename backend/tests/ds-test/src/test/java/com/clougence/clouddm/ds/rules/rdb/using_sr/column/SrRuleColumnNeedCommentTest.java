...
public class SrRuleColumnNeedCommentTest extends SrAbstractRuleTest {
    ...
    public void columnNeedComment_1() throws IOException {
        ...
        // true
        sql = "create table test.abc_test(id int(4) comment 'abc')";
        assert runScript(scriptResource, sql, p1);
        sql = "alter table test.abc add column name varchar(25) comment 'aac';";
        assert runScript(scriptResource, sql, p1);
        sql = "alter table test.abc modify column name varchar(25);";
        assert runScript(scriptResource, sql, p1);
        sql = "alter table test.abc modify column name varchar(25) comment 'ccc';";
        assert runScript(scriptResource, sql, p1);
    }
