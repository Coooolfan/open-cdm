...
public class McRuleColumnNameLengthTest extends McAbstractRuleTest {
    ...
    public void columnNameLength_1() throws IOException {
        ...
        sql = "alter table test add columns ( a123456 int);";
        assert runScript(scriptResource, sql, p1);
        sql = "alter table test change a1 a123456 int;";
        assert runScript(scriptResource, sql, p1);
    }
