...
public class ChRuleTableNeedColumnsTest extends ChAbstractRuleTest {
    ...
    public void needColumns_1() throws IOException {
        ...
        sql = "create table test.abc(a int,b int,c int,d int) engine = test";
        assert runScript(scriptResource, sql, p1);
        //        sql = "alter table test.abc convert to character set utf8mb4;";
        //        assert runScript(scriptResource, sql, p1);

        sql = "create table test.abc(a int,b int,d int) engine = test";
        assert !runScript(scriptResource, sql, p1);
    }
}
