...
public class MsRuleColumnVarCharLengthTest extends MsAbstractRuleTest {
    ...
    public void columnVarchar_1() throws IOException {
        ...
        assert runScript(scriptResource, sql, p1);
        sql = "alter table abc alter column a1 varchar(10);";
        assert runScript(scriptResource, sql, p1);
    }
    ...
    public void columnNVarchar_1() throws IOException {
        ...
        assert runScript(scriptResource, sql, p1);
        sql = "alter table abc alter column a1 nvarchar(10);";
        assert runScript(scriptResource, sql, p1);
    }
