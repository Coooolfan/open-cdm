...
public class OraRuleTableMaxColumnsTest extends OraAbstractRuleTest {
    ...
    public void createTableMaxColumns_1() throws IOException {
        ...
        sql = "create table test.abc_test(id int primary key, name varchar(25) not null, age varchar(25) not null)";
