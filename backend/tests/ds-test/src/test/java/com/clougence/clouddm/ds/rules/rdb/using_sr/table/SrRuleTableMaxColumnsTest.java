...
public class SrRuleTableMaxColumnsTest extends SrAbstractRuleTest {
    ...
    public void createTableMaxColumns_1() throws IOException {
        ...
        sql = "create table test.abc_test(id int(4), name varchar(25) not null, age varchar(25) not null)";
        assert !runScript(scriptResource, sql, p2);
        sql = "create table test.abc_test(id int, name varchar(25) not null)";
        assert runScript(scriptResource, sql, p2);
