package com.clougence.clouddm.ds.rules.rdb.using_ora.update;
...
public class OraRuleUpdateAllowSubQueryTest extends OraAbstractRuleTest {
    ...
    public void setHasSelect_1() throws IOException {
        ...
        sql = "update table1 t1 set t1.a=(select id from bb)";
