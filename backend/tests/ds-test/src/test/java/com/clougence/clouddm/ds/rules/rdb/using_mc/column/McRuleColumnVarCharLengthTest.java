...
public class McRuleColumnVarCharLengthTest extends McAbstractRuleTest {
    ...
    public void columnVarchar_1() throws IOException {
        ...
        sql = "alter table test add columns ( a123 varchar(10));";
        assert runScript(scriptResource, sql, p1);
        sql = "alter table test change a1 a123 varchar(10);";
        assert runScript(scriptResource, sql, p1);
    }
    ...
    public void columnNVarchar_1() throws IOException {
        ...
        assert !runScript(scriptResource, sql, p1);
        sql = "alter table test add columns (a123 nvarchar(10));";
        assert runScript(scriptResource, sql, p1);
