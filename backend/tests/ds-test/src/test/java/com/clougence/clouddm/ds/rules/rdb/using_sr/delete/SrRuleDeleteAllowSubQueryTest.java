...
public class SrRuleDeleteAllowSubQueryTest extends SrAbstractRuleTest {
    ...
    public void testHasWhereSelect_1() throws IOException {
        ...
        sql = "delete from test_specify_column where id = (select id from t)";
    ...
    public void testHasWhereSelect_3() throws IOException {
        ...
        sql = "delete from test_specify_column where id = (select id from t1)";
