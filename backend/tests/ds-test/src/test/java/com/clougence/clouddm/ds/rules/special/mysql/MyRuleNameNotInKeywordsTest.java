package com.clougence.clouddm.ds.rules.special.mysql;
...
public class MyRuleNameNotInKeywordsTest extends MyAbstractRuleTest {

    private final String scriptResource = "rule-test/special/mysql/my-name-not-in-keywords.txt";
