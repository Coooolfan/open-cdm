 ...
 */
package com.clougence.clouddm.ds.starrocks.resource;
...
public class SrEditorResourceSpi implements ResourceSpi {

    private final ResourceLoader resourceLoader;

    public SrEditorResourceSpi(ClassLoader loader){
    ...
    private ResourceObject keywordsResource() {
        return new ClasspathResourceObject(resourceLoader, "META-INF/clougence/db-keywords/starrocks.keywords", "text/plain;charset=UTF-8", true, true);
    }
}
