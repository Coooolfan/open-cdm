 ...
 */
package com.clougence.clouddm.dsfamily.postgres.resource;
...
public class PgEditorResourceSpi implements ResourceSpi {

    private final ResourceLoader resourceLoader;

    public PgEditorResourceSpi(ClassLoader loader){
    ...
    private ResourceObject keywordsResource() {
        return new ClasspathResourceObject(resourceLoader, "META-INF/clougence/db-keywords/postgresql.keywords", "text/plain;charset=UTF-8", true, true);
    }
}
