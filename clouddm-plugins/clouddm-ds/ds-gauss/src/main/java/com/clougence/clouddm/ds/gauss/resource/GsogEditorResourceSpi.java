 ...
 */
package com.clougence.clouddm.ds.gauss.resource;
...
public class GsogEditorResourceSpi implements ResourceSpi {

    private final ResourceLoader resourceLoader;

    public GsogEditorResourceSpi(ClassLoader loader){
        this.resourceLoader = new ClassPathResourceLoader(Objects.requireNonNull(loader, "loader"), "");
    }

    @Override
    public String name() {
        return DataSourceType.GaussDBForOpenGauss.name();
    }
    ...
    private ResourceObject keywordsResource() {
        return new ClasspathResourceObject(resourceLoader, "META-INF/clougence/db-keywords/gaussdb.keywords", "text/plain;charset=UTF-8", true, true);
    }
}
