 ...
 */
package com.clougence.clouddm.ds.ads.resource.ads4my;
...
public class AdsMyEditorResourceSpi implements ResourceSpi {

    private final ResourceLoader resourceLoader;

    public AdsMyEditorResourceSpi(ClassLoader loader){
        this.resourceLoader = new ClassPathResourceLoader(Objects.requireNonNull(loader, "loader"), "");
    }

    @Override
    public String name() {
        return DataSourceType.AdbForMySQL.name();
    }
    ...
    private ResourceObject keywordsResource() {
        return new ClasspathResourceObject(resourceLoader, "META-INF/clougence/db-keywords/adbmysql.keywords", "text/plain;charset=UTF-8", true, true);
    }
}
