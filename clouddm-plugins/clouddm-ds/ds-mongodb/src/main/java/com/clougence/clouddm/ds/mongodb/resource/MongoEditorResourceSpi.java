 ...
 */
package com.clougence.clouddm.ds.mongodb.resource;
...
public class MongoEditorResourceSpi implements ResourceSpi {

    private final ResourceLoader resourceLoader;

    public MongoEditorResourceSpi(ClassLoader loader){
    ...
    private ResourceObject keywordsResource() {
        return new ClasspathResourceObject(resourceLoader, "META-INF/clougence/db-keywords/mongodb.keywords", "text/plain;charset=UTF-8", true, true);
    }
}
