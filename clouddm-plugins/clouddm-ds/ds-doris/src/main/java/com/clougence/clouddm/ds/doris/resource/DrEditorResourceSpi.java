 ...
 */
package com.clougence.clouddm.ds.doris.resource;
...
public class DrEditorResourceSpi implements ResourceSpi {

    private final ResourceLoader resourceLoader;

    public DrEditorResourceSpi(ClassLoader loader){
    ...
    private ResourceObject keywordsResource() {
        return new ClasspathResourceObject(resourceLoader, "META-INF/clougence/db-keywords/doris.keywords", "text/plain;charset=UTF-8", true, true);
    }
}
