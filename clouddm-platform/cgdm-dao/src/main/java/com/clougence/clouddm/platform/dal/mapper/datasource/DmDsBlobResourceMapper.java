 ...
 **/
public interface DmDsBlobResourceMapper extends BaseMapper<DmDsBlobResourceDO> {

    DmDsBlobResourceDO queryByIdentify(String instanceId, ResourceType resourceType, SecurityFileType fileType);
