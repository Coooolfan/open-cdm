 ...
 **/
public interface DmAuthApprovalMapper extends BaseMapper<DmAuthApprovalDO> {

    DmAuthApprovalDO getAuthTicketInfo(@Param("rdpTickedInsId") String rdpTickedInsId);
}
