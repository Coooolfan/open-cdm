 ...
 **/
public interface DmAuthRoleMapper extends BaseMapper<DmAuthRoleDO> {

    List<DmAuthRoleDO> queryByOwnerUid(String uid);

    List<DmAuthRoleDO> queryByRoleName(String uid, String roleName);

    int updateRole(long roleId, String roleName, String newLabels);

    void updateInnerRoleByName(String roleName, String newLabels);

    List<DmAuthRoleDO> listByIds(List<Long> ids);
}
