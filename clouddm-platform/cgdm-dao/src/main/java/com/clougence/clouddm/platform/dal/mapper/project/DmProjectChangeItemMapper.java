...
import com.clougence.clouddm.platform.dal.model.project.ChangeItemType;
...
public interface DmProjectChangeItemMapper extends BaseMapper<DmProjectChangeItemDO> {
    ...
    List<DmProjectChangeItemDO> queryChangeItemByChangeId(String ownerUid, long refChangeId, ChangeItemType itemType);
