 ...
 **/
public interface DmExecSessionMapper extends BaseMapper<DmExecSessionDO> {

    DmExecSessionDO queryBySessionId(String uid, String sessionId);

    List<DmExecSessionDO> queryByUser(String uid);

    DmExecSessionDO queryByWsnSessionId(String sessionId, String wsn);
    ...
    int updateSessionConfig(DmExecSessionDO sessionDO);
