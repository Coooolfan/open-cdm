...
public interface PluginResourceModel {

    String getQualifiedResourceName();
    ...
    InputStream getInputStream(ResourceRequest request) throws IOException;

    PluginResourceData load(ResourceRequest request) throws IOException;
